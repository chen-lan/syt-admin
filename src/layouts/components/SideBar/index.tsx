  ...
  return (
    <Sider collapsible collapsed={collapsed} onCollapse={onCollapse} breakpoint="lg">
      <h1 className="layout-title">
        ...
        <span style={{ display: collapsed ? "none" : "inline-block" }}>尚医通平台管理系统</span>
      </h1>
      <Menu theme="dark" mode="inline" openKeys={openKeys} selectedKeys={selectedKeys} items={menuItems} onClick={handleMenuClick} onOpenChange={handleOpenChange}></Menu>
    </Sider>
  );
}
